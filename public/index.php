          ...
          foreach ($outcomes as $outcome) { ?>
                    <li class="list-group-item">
                        <form action="" method="post">
                            ...
                            <input class="form-check-input float-start" type="checkbox" name="status"
                                value="<?php echo $outcome['status']; ?>" id="" onChange="this.form.submit()"
                                <?php echo ($outcome['status'] == 1) ? 'checked' : ''; ?> />

                        </form>

                        <span class="float-start">
                            &nbsp;<?php echo ($outcome['date'] != '0000-00-00') ? $outcome['date'] : ''; ?>
                        </span>
