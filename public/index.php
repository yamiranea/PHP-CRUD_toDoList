      ...
      <div class="card-body">
        <div class="mb-3">
          <form action="" method="post">
            ...
            <input type="text" class="form-control" name="task" id="task" aria-describedby="helpId" placeholder="Add a new thing you want to do" />
            <br />
          ...
          foreach ($outcomes as $outcome) { ?>
            <li class="list-group-item">
              <form action="" method="post">
                ...
                <input class="form-check-input float-start" type="checkbox" name="status" value="<?php echo $outcome['status']; ?>" id="" onChange="this.form.submit()" <?php echo ($outcome['status'] == 1) ? 'checked' : ''; ?> />
